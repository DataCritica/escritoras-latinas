...
if selected_country:
    ...
    for e in edge_data:
        ...
        net.add_node(tgt, tgt, size=15, title=f'<p style="font-family: Arial, Helvetica, sans-serif; width: auto; margin: 8px;">{bio}<br><br><a href="{url}" target="_blank">Leer más</a></p>', color='#23DC5F')
